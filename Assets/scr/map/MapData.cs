...
public class MapData : MonoBehaviour
{
    ...
    public void LoadMapData(MapData_scrobj stagedata)
    {
        ...
        //基本データを受け取る
        Last = mapData_Scrobj.laststage;
        Boss = mapData_Scrobj.bossstage;
        Boss_Reverse = mapData_Scrobj.bossstage_reverse;
    ...
    public bool Boss_Reverse
    {
        get { return boss_reverse; }
        set { boss_reverse = value; }
    }
